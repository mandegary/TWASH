...
const HomePage = (props) => {
    ...
    return (
        <React.Fragment>
            ...
            <div style={{display: displayLoginForm ? "block" : "none"}}>
                ...
                <footer className="mt-5">
                    <div className="w-100 h-100  d-md-flex flex-row justify-content-center align-items-center">
                        <div className="w-25 text-center footerItem">
                            <ul>
                        ...
                        <div className="w-50 text-center footerItem">
                            <img src={flogo} className="img-fluid"/>
                            <div className="">
                        ...
                        <div className="w-25 text-center d-flex flex-md-column flex-row justify-content-center footerItem">
                            <Link href="/tsapp">
