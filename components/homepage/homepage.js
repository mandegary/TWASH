...
const HomePage = (props) => {
  ...
  const [advantageTxt, setAdvantageTxt] = useState(
  ...
  const sendCode = (mobile, referral_Code) => {
    ...
    axios
      .post(url + "/sanctum/sendVerifyCode", data, {
        headers: {
        ...
        <React.Fragment>
          <main className="homeMain">
            <div className="vh-100 position-relative home-Form">
              <div
                className="mt-3 d-flex flex-column justify-content-center align-items-center logoMiddle"
                style={{ height: "20vh" }}
              >
                <img
                  src={logo}
              ...
              <div
                className="top-design d-flex justify-content-center align-items-center"
                style={{ height: "60vh" }}
              >
                <Form formAction={sendCode} />
              </div>
            ...
            <div className="advantages vh-100 d-md-flex flex-md-row pr-2 pl-2 pr-sm-5 pl-sm-5 w-100 advantagesTxt d-flex flex-column justify-content-center align-items-start">
              <ul className="order-md-0 order-1 vh-100 w-25 text-center w-sm-100 d-flex d-md-block ">
                ...
                <li
                  onClick={(e) =>
                    advantageTxtHandler(
                      e,
                      "صرفه جویی و مدیریت زمان",
                      "شما این امکان را دارید که سفارش خود را برای همین امروز و یا روزهای آینده (حداکثر دو هفته بعد) و در محل مورد نظر خود ثبت کنید. هنگامی که در منزل در حال استراحت هستید یا در محل کار مشغول فعالیت های روزانه، خودرویتان شسته خواهد شد و شما از صرف زمان در انجام فعالیت های دلخواه خود، لذت خواهید برد."
                    )
                  }
                >
                ...
                <li
                  onClick={(e) =>
                    advantageTxtHandler(
                      e,
                      "اجتناب از حضور در محیط آلوده کارواش های سنتی",
                      "حضور در محیط پر سروصدا و آلوده کارواش های سنتی، توقف های طولانی در نوبت و معطل شدن در طول مدت شستشو، مصرف سوخت اضافه و استهلاک خودرو و احتمال تصادفات در مسیر رفت و برگشت همواره برای مشتریان (علی الخصوص بانوان)، آزاردهنده بوده است. با استفاده از خدمات تی‌سَپ، کارواشمن های ما در محل مورد نظر شما (چه حیاط یا پارکینگ منزل یا محل کار، چه در کوچه یا خیابان) حضور یافته و موجب آرامش خاطر و صرفه جویی در زمان شما خواهند شد."
                    )
                  }
                >
              ...
              <div className="order-md-1 order-0 vh-100 advantagesTxtCntr d-flex flex-column align-items-start justify-content-center text-center w-50 w-sm-100">
                ...
                />
                <div
                  className="border w-75 mr-auto ml-auto mt-1 p-1 mb-5"
                  style={{ height: "60vh" }}
                >
                  <p className="text-center" style={{ color: "#02868b" }}>
                    {advantageTitle}
                  </p>
                  <p className="text-justify p-3" style={{ fontSize: "16px" }}>
                    {advantageTxt}
                  </p>
                </div>
              </div>
              <ul className="order-md-2 order-2 vh-100 w-25 text-center w-sm-100 d-flex d-md-block ">
                ...
                <li
                  onClick={(e) =>
                    advantageTxtHandler(
                      e,
                      "استفاده از مواد نانوی برگزیده",
                      "در شستشوی خودروی شما از بهترین مواد و دستمال های نانو استفاده خواهد شد. موادی که در طول سالها تجربه، کارایی خود را اثبات کرده و برای شستشوی خودروی شما عزیزان برگزیده شده اند. کارواشمن های تی‌سَپ ملزم به استفاده از مواد مورد تایید واحد کنترل کیفیت تی‌سَپ می باشند."
                    )
                  }
                >
            ...
            <div className="team vh-100 mb-5 mt-5">
              ...
              <div className="teamtop p-5" style={{ height: "40vh" }}>
                <img
                  src={team}
                  className="w-auto m-3 img-fluid"
                  style={{ height: "100%" }}
                />
              </div>
              <ul
                className="d-flex flex-md-row justify-content-around teamItems flex-column"
                style={{ height: "60vh" }}
              >
                <li className="w-25 text-center w-sm-100">
                  <div>تیم مدیریتی:</div>
                  <p>
                    تیم مدیریت تی‌سَپ ترکیبی از مدیران جوان و باتجربه است. تیمی
                    پرانرژی و خلاق و دارای چندین سال تجربه در کارواش با مواد
                    نانو، که با استفاده از پلتفرمی که ایجاد نموده، بهترین تجربه
                    شستشوی خودرو را برای شما به ارمغان خواهد آورد.
                  </p>
                </li>
                <li className="w-25 text-center w-sm-100">
                  <div>تیم کارواشمن:</div>
                  <p>
                    کارواشمن های تی‌سَپ پس از گذراندن آموزش های لازم در امر
                    ارائه خدمات و همچنین نحوه برخورد با مشتریان و رعایت نظم و
                    انضباط و پروتکل های بهداشتی حین شستشو، آماده ارائه خدمات به
                    مشتریان عزیز می باشند.
                  </p>
                </li>
                <li className="w-25 text-center w-sm-100">
                  <div>تیم پشتیبانی:</div>
                  <p>
                    شما می توانید در هر زمان، چه در زمان ثبت سفارش چه قبل یا حین
                    شستشو، با پشتیبانی آنلاین ما با شماره 09381564444 در تماس
                    باشید و مشکلات و پیشنهادات خود را مطرح نمایید. همچنین در بخش
                    تماس با ما، تیم پیشتیبانی تی‌سَپ آماده شنیدن نظرات و
                    پیشنهادات و انتقادات ارزشمند شما عزیزان می باشد.
                  </p>
                </li>
              </ul>
            </div>
            ...
            <div className="">
              ...
              <div className="surpriseTxt text-center p-3">
                <h6 className="mb-3">هدایای تی‌سَپ</h6>
                <p>
                  شما با معرفی تی‌سَپ به دوستان و عزیزانتان می توانید اعتبار 10
                  هزار تومانی هدیه گرفته و در شستشوی بعدی از آن استفاده کنید.
                  برای این کار، فرد معرفی شده می بایست کد معرف شما را هنگام ورود
                  به سایت، در محل مشخص شده وارد نماید. همچنین دوست شما با وارد
                  کردن کد معرف شما، 12 هزار تومان اعتبار هدیه خواهد گرفت.
                </p>
              </div>
              ...
              <div className="comments w-75 mr-auto ml-auto text-right w-sm-100 mb-3">
                ...
                <div className="border d-flex align-items-md-start mt-2 align-content-center flex-column-reverse flex-md-row align-items-center m-md-0 m-2 ">
                  <p className="m-5">
                    شما با ثبت اولین سفارش، عضو خانواده بزرگ مشتریان تی‌سَپ
                    خواهید شد. شما با ارائه نظرات و انتقادات و پیشنهادات خود،
                    ضمن کمک به ما در بهبود ارائه خدمات، در قرعه کشی های مناسبتی
                    نیز مشارکت داده خواهید شد.
                  </p>
          ...
          <footer className="mt-5">
            <div className="w-100 h-100  d-flex flex-md-row flex-column justify-content-center align-items-center">
              ...
              <div className="w-50 w-sm-100 text-center footerItem footerItemLogo order-md-1 order-0">
                ...
                />
                <div className="">
                  <div className="mt-3 d-flex flex-row text-right text-md-center  justify-content-center align-items-center pr-3 pl-3">
                    <p>
              ...
              <div className="footerItemIcons w-25 w-sm-50 order-md-2 order-2  text-center d-flex flex-md-column flex-row justify-content-center footerItem order-md-2">
                <Link href="https://instagram.com/tsapp.ir?utm_medium=copy_link">
