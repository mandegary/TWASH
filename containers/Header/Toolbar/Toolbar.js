            ...
            const promise = window
                ...
                .then(responseJson => {
                    if (responseJson.message == "Unauthenticated.")
                        VerifyToken();
                    else if (responseJson.message == "اعتبار کاربر با موفقیت دریافت شد") {
        ...
        <header className={_class} id="header" ref={startRef}>
            <Container>
                <Row>
                                ...
                                {token ?
                                    <div className="avatar userLnk">
                                        ...
                                        <div className="userMenu">
                                            ...
                                            <span className="exitLnk" onClick={logout}>خروج</span>
                                        </div>
                                    </div>
                    ...
                    <SideDrawer show={openSideDrawer} closeDrawer={closeDrawer} showCodeModal={showCodeModal}/>
                </Row>
